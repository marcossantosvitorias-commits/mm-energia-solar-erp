...
export default function PrecosKitsPage() {
  ...
  const kitsOrdenados=[...kitsBelenus].sort((a,b)=>Number(a.placas||0)-Number(b.placas||0));
  ...
  return (
    ...
    >
      <div className="kits-pricing-page">
        {kitsOrdenados.length>0&&<section className="finance-panel">
          <div className="finance-panel-header">
            <div>
              <h2>Kits enviados da Belenus</h2>
              <p>Kits cadastrados e organizados pela quantidade de placas.</p>
            </div>
          ...
          <div className="published-kit-grid">
            {kitsOrdenados.map(kit=><article className="published-kit-card" key={kit.id}>
              <span className="published-kit-badge"><BadgeCheck size={14}/> Belenus</span>
              ...
              <Link to="/app/precos/microinversor">Abrir kit <ArrowRight size={15}/></Link>
            </article>)}
          </div>
        </section>}
