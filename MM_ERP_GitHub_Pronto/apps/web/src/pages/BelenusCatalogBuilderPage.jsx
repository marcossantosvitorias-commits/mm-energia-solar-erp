                      ...
                      {catalogoEtapa.map((item) => {
                        ...
                        return (
                          <article className={`bel-product-row ${selecionado ? 'selected' : ''}`} key={item.sku}>
                            ...
                            <button type="button" className="bel-add-button" onClick={() => adicionar(item)}>
                              {selecionado ? <><CheckCircle2 size={16} /> Atualizar</> : <><PackagePlus size={16} /> Adicionar</>}
                            </button>
                          </article>
                        );
                      })}
